...
class warning(object):
	...
	def update(self):
		...
		agent_reward = self.get_reward( action, self.car.braked)
	...
	def get_action(self):
		...
		a_prime = self.epsilon_greedy_action( max_index, self.epsilon)
	...
	def getFeatureVector( self, action):
